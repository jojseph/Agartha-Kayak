...
// figures out which communities have queued rows itself. New communities are
// picked up automatically. The worker submits to Cardano via Blockfrost (see
// src/lib/cardano/txBuilder.ts).
//
