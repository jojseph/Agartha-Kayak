...
/**
 * POST /api/loans/treasury/repayment
 * Elder or Owner logs an off-chain repayment for an approved treasury loan.
 *
 * Rules:
 * - Only elders/owners can call this (they handle off-chain payments)
 * - The elder CANNOT confirm their own treasury loan repayment
 * - Automatically marks the loan as `fully_paid` if total paid >= total owed
 * - Enqueues an on-chain receipt for the repayment confirmation
 *
 * Body: { loanId, amount, method?, elderAddress }
 */
export async function POST(request: Request) {
    ...
    try {
        ...
        // Verify caller role and get their community
        ...
        // Self-protection: elder cannot confirm their own loan
        ...
        // Insert the confirmed repayment
...
/**
 * GET /api/loans/treasury/repayment?loanId=...
 * Returns repayment summary for a given treasury loan.
 */
